...
TEST(moead_test, moead_evolve_test)
{
    ...
    // Some bound is equal
    EXPECT_THROW(moead{10u}.evolve(population{problem{mo_equal_bounds{}}, 0u}), std::invalid_argument);
    // Empty population.
    EXPECT_THROW(moead{10u}.evolve(population{problem{rosenbrock{}}, 0u}), std::invalid_argument);
    // Single objective problem
    EXPECT_THROW(moead{10u}.evolve(population{problem{rosenbrock{}}, 20u}), std::invalid_argument);
    // Multi-objective problem with constraints
    EXPECT_THROW(moead{10u}.evolve(population{problem{mo_con{}}, 20u}), std::invalid_argument);
    // Stochastic problem
