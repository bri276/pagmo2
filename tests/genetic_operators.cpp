...
TEST(generic_test, sbx_crossover_test)
{
    ...
    BOOST_CHECK_EXCEPTION(
        sbx_crossover({0.1, 0.2, 0.3}, {0.2, 2.2, -1}, {{}, {}}, 1u, 0.9, 10, random_engine), std::invalid_argument,
        [](const std::invalid_argument &ia) { return ia.what().contains("The bounds dimension cannot be zero"); });
    BOOST_CHECK_EXCEPTION(
        sbx_crossover({0.1, 0.2, 0.3}, {0.2, 2.2, -1}, {{-2, -2}, {3, 3, 3}}, 1u, 0.9, 10, random_engine),
        std::invalid_argument,
        [](const std::invalid_argument &ia) { return ia.what().contains("The length of the lower bounds vector is"); });
    BOOST_CHECK_EXCEPTION(
    ...
    BOOST_CHECK_EXCEPTION(
        ...
        std::invalid_argument, [](const std::invalid_argument &ia) {
            return ia.what().contains("Infinite value detected in the bounds at position");
        });
    BOOST_CHECK_EXCEPTION(
    ...
    BOOST_CHECK_EXCEPTION(
        ...
        std::invalid_argument,
        [](const std::invalid_argument &ia) { return ia.what().contains("The lower bound at position"); });
    BOOST_CHECK_EXCEPTION(
    ...
    BOOST_CHECK_EXCEPTION(
        ...
        std::invalid_argument, [](const std::invalid_argument &ia) {
            return ia.what().contains("The integer part cannot be larger than the bounds size");
        });
    BOOST_CHECK_EXCEPTION(
        sbx_crossover({0.1, 0.2, 0.3}, {0.2, 2.2, -1}, {{-2, -2, -2.6}, {3, 3, 3}}, 1u, 0.9, 10, random_engine),
        std::invalid_argument, [](const std::invalid_argument &ia) {
            return ia.what().contains("A lower bound of the integer part of the decision vector is");
        });
    BOOST_CHECK_EXCEPTION(
        sbx_crossover({0.1, 0.2, 0.3}, {0.2, 2.2, -1}, {{-2, -2, -2}, {3, 3, 3.43}}, 1u, 0.9, 10, random_engine),
        std::invalid_argument, [](const std::invalid_argument &ia) {
            return ia.what().contains("An upper bound of the integer part of the decision vector is");
        });
    BOOST_CHECK_EXCEPTION(
...
TEST(generic_test, polynomial_mutation_test)
{
    ...
    BOOST_CHECK_EXCEPTION(
        polynomial_mutation(dv, {{}, {}}, 1u, 0.9, 10, random_engine), std::invalid_argument,
        [](const std::invalid_argument &ia) { return ia.what().contains("The bounds dimension cannot be zero"); });
    BOOST_CHECK_EXCEPTION(
        polynomial_mutation(dv, {{-2, -2}, {3, 3, 3}}, 1u, 0.9, 10, random_engine), std::invalid_argument,
        [](const std::invalid_argument &ia) { return ia.what().contains("The length of the lower bounds vector is"); });
    BOOST_CHECK_EXCEPTION(
